...
obj.row[obj.headerlist.index('NON_INTERST_BEARING_BALLOON_ALLOWED')] = obj.NON_INTERST_BEARING_BALLOON_ALLOWED
...
obj.row[obj.headerlist.index('AddInterimMonth')] = obj.AddInterimMonth
...
obj.row[obj.headerlist.index('MODLASTUPDATE')] = obj.MODLASTUPDATE
obj.row[obj.headerlist.index('FBLASTUPDATE')] = obj.FBLASTUPDATE
obj.row[obj.headerlist.index('DILLASTUPDATE')] = obj.DILLASTUPDATE
obj.row[obj.headerlist.index('SSLASTUPDATE')] = obj.SSLASTUPDATE
...
obj.row[obj.headerlist.index('NON_INTERST_BEARING_BALLOON_ALLOWED_Updated ( Yes/No )')] = obj.NON_INTERST_BEARING_BALLOON_ALLOWED_Updated
...
obj.row[obj.headerlist.index('AddInterimMonth_Updated ( Yes/No )')] = obj.AddInterimMonth_Updated
...
obj.row[obj.headerlist.index('FORBEARANCE_PLAN_ALLOWED_Updated ( Yes/No )')] = obj.FORBEARANCE_PLAN_ALLOWED_Updated
...
obj.row[obj.headerlist.index('MATURITY_RESTRICTION_DATE_Updated ( Yes/No )')] = obj.MATURITY_RESTRICTION_DATE_Updated
...
obj.row[obj.headerlist.index('MIN_PRE_MOD_LTV_Updated ( Yes/No )')] = obj.MIN_PRE_MOD_LTV_Updated
